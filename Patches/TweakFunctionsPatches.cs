...
namespace VagrusTranslationPatches.Patches
{
    ...
    internal class TweakFunctionsPatches
    {
        ...
        [HarmonyPatch("GetDefaultSaveFileName")]
        [HarmonyPrefix]
        public static void GetDefaultSaveFileName_postfix(ref string __result)
        {
            __result = "Save day".FromDictionary()+" " + Game.game.calendar.GetDayCount();
        }
    }
}